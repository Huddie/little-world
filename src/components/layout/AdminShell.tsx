import { AlertTriangle, BookOpen, Brain, Globe2, Lightbulb, PackageCheck, RefreshCw, Users } from "lucide-react";
...
const adminLinks = [
  ...
  { to: "/admin/inspirations", label: "Inspiration", icon: Lightbulb },
